// Only these "Auth wrapper, responsive layout, and user provider"
...
class OptimizedMyApp extends StatefulWidget {
  const OptimizedMyApp({super.key});

  @override
  State<OptimizedMyApp> createState() => _OptimizedMyAppState();
}
  ...
  void _checkCountryInBackground() {
    Future.delayed(const Duration(seconds: 1), () {
      try {
        ...
        print('Country check in observer failed: $e');
      }
    });
  }
}
